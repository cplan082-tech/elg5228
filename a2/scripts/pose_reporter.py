...
class pose_reporter():
    ...
    def loginfo_pub(self):
        ...
        self.pose_pub.x = self.pose.x
        self.pose_pub.y = self.pose.y
        self.pose_pub.theta = np.rad2deg(self.pose.theta)
        
        self.pose_pub.linear_velocity = dist2go
        self.pose_pub.angular_velocity = orient_err
        ...
        self.pub_drv_cmd.publish(self.pose_pub)
